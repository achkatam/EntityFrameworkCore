...
namespace VaporStore.Migrations
{
    ...
    [Migration("20230328185935_RemovedTagFromGames")]
    partial class RemovedTagFromGames
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VaporStore.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VaporStore.Data.Models.Game", b =>
                {
                    ...
                    b.HasOne("VaporStore.Data.Models.Tag", null)
                        .WithMany("Games")
                        .HasForeignKey("TagId");
